    ...
    <ol class="round">
        <li class="one">
            ...
            <code>
                ...
                install-package DynamicDataTemplatesCS<br />
        ...
        <li class="two">
            ...
            <br /><br /> 
            Open DateTime_Edit.ascx.cs file and add the following code to the Page_Load method:<br /><br />
            <code>
                RangeAttribute ra = (RangeAttribute)Column.Attributes[typeof(RangeAttribute)];<br />
                if (ra != null)<br />
                {<br />
