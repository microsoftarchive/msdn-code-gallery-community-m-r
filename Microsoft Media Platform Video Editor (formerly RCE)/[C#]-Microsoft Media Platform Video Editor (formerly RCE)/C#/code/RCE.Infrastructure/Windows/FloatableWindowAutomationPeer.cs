// <copyright file="FloatableWindowAutomationPeer.cs" company="Microsoft Corporation">
// ===============================================================================
//
//
// Project: Microsoft Silverlight Rough Cut Editor
// FILES: FloatableWindowAutomationPeer.cs                     
//
// ===============================================================================
        ...
        private bool IsTopMostPrivate
        {
            ...
            set
            {
                if (this.isTopMost != value)
                {
                    ...
                    this.RaisePropertyChangedEvent(WindowPatternIdentifiers.IsTopmostProperty, !this.isTopMost, this.isTopMost);
                }
            }
        }
