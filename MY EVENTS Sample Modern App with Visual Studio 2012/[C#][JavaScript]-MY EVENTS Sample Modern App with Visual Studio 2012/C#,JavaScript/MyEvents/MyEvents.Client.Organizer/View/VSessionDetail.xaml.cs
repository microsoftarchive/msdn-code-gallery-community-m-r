...
namespace MyEvents.Client.Organizer.View
{
    ...
    /// </summary>
    public sealed partial class VSessionDetail : Page
    {
        public VSessionDetail()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            vm.Attendees = null;
            vm.Load();
            vm.InitializeData(e.Parameter as Session);            
        }
        ...
        private void SessionsPinButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            (this.DataContext as SessionDetailViewModel).PinToStartCommand.Execute(rect);
        }
    }
}
