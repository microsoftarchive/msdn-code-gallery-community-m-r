...
namespace ImageFunctions.Classes
{
	class ImageStatistics
	{
		...
		public delegate void StatisticsCompleteHandler(ArrayList Statistics);
		...
		public void GetStatistics()
		{
			...
			string path = Path.Combine(Application.StartupPath, "Binn\\gm");
			...
			//psi.Arguments = "-verbose " + "\"" + this.CurrentImage + "\"";
			//
