...
Public Class CustomersForm
    ...
    Public Sub UpDateDataTable(ByVal sender As Object(), ByVal CurrentPosition As Integer, ByVal Total As Integer)
        Try
            If Me.InvokeRequired Then
                Me.Invoke(New UpdateDataTableDelegateProgress(AddressOf UpDateDataTable), sender, CurrentPosition, Total)
            Else
                If dt.Columns.Count > 0 Then
                    dt.Rows.Add(sender)
    ...
    Private Async Sub cmdLoad_Click(sender As Object, e As EventArgs) Handles cmdLoad.Click
        ...
        Dim da As New DataAccess With {.UseProgressBar = chkUseProgressBar.Checked}
        ...
        For Each item As Object() In da.LoadCustomers(token)
            ...
            ' intentionally show down else things will happen to fast but
            ' at run time use Await Task.Delay(0)
