...
Public Class frmSALE_RETURN_WHOLE_INV
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmSALE_RETURN_WHOLE_INV))
        ...
        Me.ColScmQty.DefaultCellStyle = DataGridViewCellStyle11
        Me.ColScmQty.HeaderText = "Scm Qty."
        Me.ColScmQty.Name = "ColScmQty"
        Me.ColScmQty.ReadOnly = True
        ...
        Me.TxtTotal.Location = New System.Drawing.Point(99, 18)
        ...
        Me.TxtRemarks.Location = New System.Drawing.Point(192, 68)
        Me.TxtRemarks.MaxLength = 50
        Me.TxtRemarks.Multiline = True
        Me.TxtRemarks.Name = "TxtRemarks"
        Me.TxtRemarks.Size = New System.Drawing.Size(180, 45)
        ...
        Me.TxtDescription.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DsV_SALE1, "V_SALE_MASTER.OTHER_DESC", True))
        Me.TxtDescription.Font = New System.Drawing.Font("Verdana", 8.25!)
        Me.TxtDescription.Location = New System.Drawing.Point(192, 43)
        ...
        Me.TxtNetTotal.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DsV_SALE1, "V_SALE_MASTER.NET_TOTAL", True))
        Me.TxtNetTotal.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Bold)
        Me.TxtNetTotal.Location = New System.Drawing.Point(99, 92)
        ...
        Me.TxtOtherDisc.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DsV_SALE1, "V_SALE_MASTER.DISC_OTHER", True))
        Me.TxtOtherDisc.Font = New System.Drawing.Font("Verdana", 8.25!)
        Me.TxtOtherDisc.Location = New System.Drawing.Point(99, 67)
        ...
        Me.Label18.Location = New System.Drawing.Point(192, 17)
        ...
        Me.TxtDiscount.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DsV_SALE1, "V_SALE_MASTER.DISC_RS", True))
        Me.TxtDiscount.Font = New System.Drawing.Font("Verdana", 8.25!)
        Me.TxtDiscount.Location = New System.Drawing.Point(99, 43)
        ...
        Me.BttnLoadInvoice.Text = "&Load Invoice"
        ...
        Me.Label3.Text = "Sale Return (Whole Invoice)"
        ...
        Me.Name = "frmSALE_RETURN_WHOLE_INV"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Sale Return Whole Invoice"
...
#Region "FORM CONTROL"
    ...
    Private Sub frmSALE_RETURN_WHOLE_INV_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        End If
    End Sub
    Private Sub frmSALE_RETURN_WHOLE_INV_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub frmSALE_RETURN_WHOLE_INV_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        Me.asNum.EnterTab(e)
    End Sub
#End Region
...
#Region "TextBox Control"
    ...
    Private Sub TxtTotal_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtOtherDisc.TextChanged, TxtDiscPercent.TextChanged, TxtDiscount.TextChanged, TxtTotal.TextChanged
        On Error GoTo Fix
...
#Region "DataGridView Control"
    ...
    '                    Me.DataGridView1.Rows(e.RowIndex - 1).Cells("ColPack").Value = Me.DataGridView1.Rows(e.RowIndex - 1).Cells("ColPack").Value + Me.DataGridView1.Rows(e.RowIndex - 1).Cells("ColPiece").Value
    '                    Me.DataGridView1.Rows(e.RowIndex - 1).Cells("ColPiece").Value = 0
    ...
    '                    PKS = PCS / PPP
    '                    Me.DataGridView1.Rows(e.RowIndex - 1).Cells("ColPack").Value = Me.DataGridView1.Rows(e.RowIndex - 1).Cells("ColPack").Value + PKS
...
#Region "Button Control"
    Private Sub BttnLoadInvoice_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttnLoadInvoice.Click
        ...
        Else
            ...
            ElseIf Ret_Status = 0 Then
                MsgBox("This Invoice # " & Val(Me.TxtInvoice.Text) & " is Already Partially Returned" & vbCrLf & "Can't be as a Whole Return!", MsgBoxStyle.Exclamation, "(NS) - Wrong Invoice!")
                Me.TxtInvoice.Focus()
                Exit Sub

            ElseIf Ret_Status = 1 Then
                MsgBox("This Invoice # " & Val(Me.TxtInvoice.Text) & " is Already Whole Returned", MsgBoxStyle.Exclamation, "(NS) - Wrong Invoice!")
                Me.TxtInvoice.Focus()
                Exit Sub
...
TOP:
        ...
        ElseIf Me.asSELECT.pFlg1 = True Then
            ...
            Try
                Me.AsInsrt.SaveValue("INSERT INTO SALE_RET_MASTER(nSINV_NO, nCLIENT_ID, dDATE, nTOTAL_BILL, nDISCOUNT, nDISC_PERCENT, nOTHERS, sOTHER_DESC, nNET_TOTAL, nEMPLOYEE_CODE, nLOGIN_ID, nBUSINESS_CODE, sREMARKS) VALUES(" & Val(Me.TxtInvoice.Text) & "," & Val(Me.TxtClientID.Text) & ", '" & CDate(Me.TxtDate.Text).ToString("MM-dd-yyyy") & "', " & Val(Me.TxtTotal.Text) & ", " & Val(Me.TxtDiscount.Text) & ", " & Val(Me.TxtDiscPercent.Text) & ", " & Val(Me.TxtOtherDisc.Text) & ", '" & Me.TxtDescription.Text & "', " & Val(Me.TxtNetTotal.Text) & ", " & Val(Me.TxtSManID.Text) & ", 10, " & Val(Me.TxtGroupID.Text) & ", '" & Me.TxtRemarks.Text & "')")
                ...
                For i = 0 To Me.DataGridView1.Rows.Count - 2
                    ...
                    Me.AsInsrt.SaveValue("INSERT INTO SALE_RETURN_NORMAL(nSRINV_NO, nITEM_CODE, sBATCH_NO, nUNIT_COST, nUNIT_RATE, nDISC_RS, nDISC_PER, nSALE_TAX, nPPP, nQTY_PKS, nQTY_PCS, nQTY_BONUS, nQTY_Tot_PCS, nTOTAL_VALUE, nRET_TYPE, dDATE) VALUES (" & Val(SR_INV) & "," & Val(Me.DataGridView1.Rows(i).Cells("ColCode").Value) & ", '" & Me.DataGridView1.Rows(i).Cells("ColBatch").Value & "', " & Val(Me.DataGridView1.Rows(i).Cells("ColCost").Value) & ", " & Val(Me.DataGridView1.Rows(i).Cells("ColRate").Value) & ", " & Val(Me.DataGridView1.Rows(i).Cells("ColDisc_Rs").Value) & ", " & Val(Me.DataGridView1.Rows(i).Cells("ColPercentage").Value) & ", " & Val(Me.DataGridView1.Rows(i).Cells("ColSaleTax").Value) & ", " & Val(Me.DataGridView1.Rows(i).Cells("ColPPP").Value) & ", " & Val(Me.DataGridView1.Rows(i).Cells("ColPack").Value) & ", " & Val(Me.DataGridView1.Rows(i).Cells("ColPiece").Value) & ", " & Val(Me.DataGridView1.Rows(i).Cells("ColBonus").Value) & ", " & Tot_Pcs & ", " & Val(Me.DataGridView1.Rows(i).Cells("ColTotal").Value) & ", 1, '" & CDate(Me.TxtDate.Text).ToString("MM-dd-yyyy") & "')")

                Next

                Me.AsInsrt.SaveValueIN("UPDATE SALE_MASTER SET nRET_STATUS=1 WHERE nSINV_NO=" & Val(Me.TxtInvoice.Text) & "")
