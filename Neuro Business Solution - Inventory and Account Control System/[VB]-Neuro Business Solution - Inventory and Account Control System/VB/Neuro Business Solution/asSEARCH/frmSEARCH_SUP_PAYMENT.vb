...
Public Class frmSEARCH_SUP_PAYMENT
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents daSUPPLIER_PAYMENT As System.Data.SqlClient.SqlDataAdapter
    ...
    Friend WithEvents DsSUPPLIER_PAYMENT1 As Neruo_Business_Solution.dsSUPPLIER_PAYMENT
    Friend WithEvents TxtDateFrom As System.Windows.Forms.TextBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmSEARCH_SUP_PAYMENT))
        ...
        Me.daSUPPLIER_PAYMENT = New System.Data.SqlClient.SqlDataAdapter
        Me.DsSUPPLIER_PAYMENT1 = New Neruo_Business_Solution.dsSUPPLIER_PAYMENT
        Me.Panel1.SuspendLayout()
        Me.GroupBox2.SuspendLayout()
        CType(Me.DsSUPPLIER_PAYMENT1, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'Panel1
        '
        ...
        Me.Label3.Text = "Supplier's Payment(s)"
        ...
        Me.Name = "frmSEARCH_SUP_PAYMENT"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "SUPPLIER PAYMENTS HISTORY"
        Me.Panel1.ResumeLayout(False)
        Me.GroupBox2.ResumeLayout(False)
        Me.GroupBox2.PerformLayout()
        CType(Me.DsSUPPLIER_PAYMENT1, System.ComponentModel.ISupportInitialize).EndInit()
...
#Region "FORM CONTROL"
    Private Sub frmSEARCH_SUP_PAYMENT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.SqlConnection1.ConnectionString = Me.asConn.Conn.ConnectionString
        Me.FillListView()
    End Sub

    Private Sub frmSEARCH_SUP_PAYMENT_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        Me.asNum.EnterTab(e)
    End Sub
#End Region
...
#Region "ListView Control"
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        ...
        If Not Me.ListView1.SelectedItems(0).Text = Nothing Then
            My.Forms.frmSUPPLIER_PAYMENT.LblID.Text = Me.ListView1.SelectedItems(0).Text

            My.Forms.frmSUPPLIER_PAYMENT.BttnSave.Enabled = True
            Me.Close()
...
#Region "Button Control"
    Private Sub BttnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttnSearch.Click
        ...
        If Not Me.TxtSupplier.Text = Nothing And Me.TxtDateFrom.Text = Nothing And Me.TxtDateTo.Text = Nothing Then
            Str2 = "SELECT ID, SUPPLIER_ID, SUPPLIER_NAME, PMT_DATE, CONVERT(NUMERIC(18,2),CASH_AMT) AS CASH_AMT, CHQ_NO, CHQ_TYPE, CHQ_DATE, CONVERT(NUMERIC(18,2),BANK_AMT) AS BANK_AMT, BANK_ACC, BANK_NAME, PINV_NO, USER_NAME, GROUP_NAME, TOT_PAYMENT, EMP_NAME, DESCRIPTION, GROUP_ID FROM V_SUPPLIER_PAYMENT WHERE SUPPLIER_NAME LIKE '%" & Me.TxtSupplier.Text & "%' ORDER BY ID DESC"
        ...
        ElseIf Not Me.TxtDateFrom.Text = Nothing And Not Me.TxtDateTo.Text = Nothing And Me.TxtSupplier.Text = Nothing Then
            Str2 = "SELECT ID, SUPPLIER_ID, SUPPLIER_NAME, PMT_DATE, CONVERT(NUMERIC(18,2),CASH_AMT) AS CASH_AMT, CHQ_NO, CHQ_TYPE, CHQ_DATE, CONVERT(NUMERIC(18,2),BANK_AMT) AS BANK_AMT, BANK_ACC, BANK_NAME, PINV_NO, USER_NAME, GROUP_NAME, TOT_PAYMENT, EMP_NAME, DESCRIPTION, GROUP_ID FROM V_SUPPLIER_PAYMENT WHERE PMT_DATE >= CONVERT(DATETIME, '" & Me.TxtDateFrom.Text & "') AND PMT_DATE <= CONVERT(DATETIME, '" & Me.TxtDateTo.Text & "') ORDER BY ID DESC"
            Me.FillListView_Condition()
...
#Region "Sub and Functions"
    Private Sub FillListView()
        Try
            Dim Str1 As String = "SELECT ID, SUPPLIER_ID, SUPPLIER_NAME, PMT_DATE, CONVERT(NUMERIC(18,2),CASH_AMT) AS CASH_AMT, CHQ_NO, CHQ_TYPE, CHQ_DATE, CONVERT(NUMERIC(18,2),BANK_AMT) AS BANK_AMT, BANK_ACC, BANK_NAME, PINV_NO, USER_NAME, GROUP_NAME, TOT_PAYMENT, EMP_NAME, DESCRIPTION, GROUP_ID FROM V_SUPPLIER_PAYMENT ORDER BY ID DESC"
            ...
            For Cnt = 0 To Me.DsSUPPLIER_PAYMENT1.V_SUPPLIER_PAYMENT.Count - 1
                LstItem = Me.ListView1.Items.Add(Me.DsSUPPLIER_PAYMENT1.V_SUPPLIER_PAYMENT.Item(Cnt).Item(0).ToString)
                Me.ListView1.Items(Cnt).UseItemStyleForSubItems = False
                With LstItem.SubItems

                    .Add(Me.DsSUPPLIER_PAYMENT1.V_SUPPLIER_PAYMENT.Item(Cnt).Item(2).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    Dim dDATE As String = Me.DsSUPPLIER_PAYMENT1.V_SUPPLIER_PAYMENT.Item(Cnt).Item(3).ToString
                    ...
                    Else
                        .Add(Me.DsSUPPLIER_PAYMENT1.V_SUPPLIER_PAYMENT.Item(Cnt).Item(3).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    End If

                    .Add(Me.DsSUPPLIER_PAYMENT1.V_SUPPLIER_PAYMENT.Item(Cnt).Item(4).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    .Add(Me.DsSUPPLIER_PAYMENT1.V_SUPPLIER_PAYMENT.Item(Cnt).Item(8).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    .Add(Me.DsSUPPLIER_PAYMENT1.V_SUPPLIER_PAYMENT.Item(Cnt).Item(9).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    .Add(Me.DsSUPPLIER_PAYMENT1.V_SUPPLIER_PAYMENT.Item(Cnt).Item(16).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
    ...
    Private Sub FillListView_Condition()
        Try
            ...
            Me.daSUPPLIER_PAYMENT = New SDS.SqlDataAdapter(SqlCmd2)
