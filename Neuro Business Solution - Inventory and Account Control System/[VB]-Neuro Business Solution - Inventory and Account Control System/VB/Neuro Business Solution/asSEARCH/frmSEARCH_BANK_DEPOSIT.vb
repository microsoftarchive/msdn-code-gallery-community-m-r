...
Public Class frmSEARCH_BANK_DEPOSIT
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DsBANK_DEPOSIT1 As Neruo_Business_Solution.dsBANK_DEPOSIT
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmSEARCH_BANK_DEPOSIT))
        ...
        Me.DsBANK_DEPOSIT1 = New Neruo_Business_Solution.dsBANK_DEPOSIT
        ...
        CType(Me.DsBANK_DEPOSIT1, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'ColumnHeader4
        '
        Me.ColumnHeader4.Text = "Dep. Amount"
        ...
        Me.Label3.Text = "Bank's Deposit(s)"
        ...
        'SqlSelectCommand1
        '
        Me.SqlSelectCommand1.CommandText = "SELECT     ID, BANK_ACC, SLIP_NO, CONVERT(NUMERIC(18,2), DEPOSIT_AMT) AS DEPOSIT_" & _
            "AMT, dDATE, sDESC, GROUP_NAME, USER_NAME, GROUP_ID" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM         V_BANK_DEPOSITS" & _
            ""
        Me.SqlSelectCommand1.Connection = Me.SqlConnection1
        '
        'daBANK_DEPOSIT
        '
        Me.daBANK_DEPOSIT.SelectCommand = Me.SqlSelectCommand1
        ...
        'DsBANK_DEPOSIT1
        '
        Me.DsBANK_DEPOSIT1.DataSetName = "dsBANK_DEPOSIT"
        Me.DsBANK_DEPOSIT1.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema
        '
        'daNS_DEFAULT
        '
        ...
        Me.Name = "frmSEARCH_BANK_DEPOSIT"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "BANK DEPOSIT HISTORY"
        Me.Panel1.ResumeLayout(False)
        Me.GroupBox2.ResumeLayout(False)
        Me.GroupBox2.PerformLayout()
        CType(Me.DsLUP_BANK1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.DsBANK_DEPOSIT1, System.ComponentModel.ISupportInitialize).EndInit()
...
#Region "FORM CONTROL"
    Private Sub frmSEARCH_BANK_DEPOSIT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub frmSEARCH_BANK_DEPOSIT_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        Me.asNum.EnterTab(e)
    End Sub
#End Region
...
#Region "ListView Control"
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        ...
        If Not Me.ListView1.SelectedItems(0).Text = Nothing Then
            My.Forms.frmBANK_DEPOSIT.LblID.Text = Me.ListView1.SelectedItems(0).Text

            My.Forms.frmBANK_DEPOSIT.BttnSave.Enabled = True
            Me.Close()
...
#Region "Button Control"
    Private Sub BttnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttnSearch.Click
        ...
        If Not Me.CmbBankAccount.Text = Nothing And Me.TxtDateFrom.Text = Nothing And Me.TxtDateTo.Text = Nothing Then
            Str2 = "SELECT ID, BANK_ACC, SLIP_NO, CONVERT(NUMERIC(18,2), DEPOSIT_AMT) AS DEPOSIT_AMT, dDATE, sDESC, GROUP_NAME, USER_NAME, GROUP_ID FROM V_BANK_DEPOSITS WHERE BANK_ACC='" & Me.CmbBankAccount.Text & "' ORDER BY ID DESC"
        ...
        ElseIf Not Me.TxtDateFrom.Text = Nothing And Not Me.TxtDateTo.Text = Nothing And Me.CmbBankAccount.Text = Nothing Then
            Str2 = "SELECT ID, BANK_ACC, SLIP_NO, CONVERT(NUMERIC(18,2), DEPOSIT_AMT) AS DEPOSIT_AMT, dDATE, sDESC, GROUP_NAME, USER_NAME, GROUP_ID FROM V_BANK_DEPOSITS WHERE dDATE >= CONVERT(DATETIME, '" & Me.TxtDateFrom.Text & "') AND dDATE <= CONVERT(DATETIME, '" & Me.TxtDateTo.Text & "') ORDER BY ID DESC"
            Me.FillListView_Condition()

        ElseIf Not Me.CmbBankAccount.Text = Nothing And Not Me.TxtDateFrom.Text = Nothing And Not Me.TxtDateTo.Text = Nothing Then
            Str2 = "SELECT ID, BANK_ACC, SLIP_NO, CONVERT(NUMERIC(18,2), DEPOSIT_AMT) AS DEPOSIT_AMT, dDATE, sDESC, GROUP_NAME, USER_NAME, GROUP_ID FROM V_BANK_DEPOSITS WHERE BANK_ACC='" & Me.CmbBankAccount.Text & "' AND dDATE >= CONVERT(DATETIME, '" & Me.TxtDateFrom.Text & "') AND dDATE <= CONVERT(DATETIME, '" & Me.TxtDateTo.Text & "') ORDER BY ID DESC"
            Me.FillListView_Condition()
...
#Region "Sub and Functions"
    ...
    Private Sub FillListView()
        Try
            Dim Str1 As String = "SELECT ID, BANK_ACC, SLIP_NO, CONVERT(NUMERIC(18,2), DEPOSIT_AMT) AS DEPOSIT_AMT, dDATE, sDESC, GROUP_NAME, USER_NAME, GROUP_ID FROM V_BANK_DEPOSITS ORDER BY ID DESC"
            Dim SqlCmd1 As New SDS.SqlCommand(Str1, Me.SqlConnection1)
            Me.daBANK_DEPOSIT = New SDS.SqlDataAdapter(SqlCmd1)

            Me.DsBANK_DEPOSIT1.Clear()
            Me.daBANK_DEPOSIT.Fill(Me.DsBANK_DEPOSIT1.V_BANK_DEPOSITS)
            ...
            For Cnt = 0 To Me.DsBANK_DEPOSIT1.V_BANK_DEPOSITS.Count - 1
                LstItem = Me.ListView1.Items.Add(Me.DsBANK_DEPOSIT1.V_BANK_DEPOSITS.Item(Cnt).Item(0).ToString)
                Me.ListView1.Items(Cnt).UseItemStyleForSubItems = False
                With LstItem.SubItems

                    .Add(Me.DsBANK_DEPOSIT1.V_BANK_DEPOSITS.Item(Cnt).Item(1).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    .Add(Me.DsBANK_DEPOSIT1.V_BANK_DEPOSITS.Item(Cnt).Item(2).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)

                    Dim dDATE As String = Me.DsBANK_DEPOSIT1.V_BANK_DEPOSITS.Item(Cnt).Item(4).ToString

                    If dDATE.Length > 0 Then
                        .Add(CDate(dDATE).ToString("dd-MMM-yyyy"), Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    Else
                        .Add(Me.DsBANK_DEPOSIT1.V_BANK_DEPOSITS.Item(Cnt).Item(4).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    End If

                    .Add(Me.DsBANK_DEPOSIT1.V_BANK_DEPOSITS.Item(Cnt).Item(3).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    .Add(Me.DsBANK_DEPOSIT1.V_BANK_DEPOSITS.Item(Cnt).Item(5).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
    ...
    Private Sub FillListView_Condition()
        Try
            ...
            Me.daBANK_DEPOSIT = New SDS.SqlDataAdapter(SqlCmd2)
