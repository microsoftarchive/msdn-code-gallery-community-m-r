...
Public Class frmSEARCH_CLIENT_RECEIPT
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmSEARCH_CLIENT_RECEIPT))
        ...
        'ColumnHeader6
        '
        Me.ColumnHeader6.Text = "Cheque Status"
        ...
        Me.Label3.Text = "Client's Receipt(s)"
        ...
        'daCLIENT_RECEIPT
        '
        Me.daCLIENT_RECEIPT.SelectCommand = Me.SqlSelectCommand1
        ...
        Me.Name = "frmSEARCH_CLIENT_RECEIPT"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "CLIENT RECEIPTS HISTORY"
...
#Region "FORM CONTROL"
    Private Sub frmSEARCH_CLIENT_RECEIPT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.SqlConnection1.ConnectionString = Me.asConn.Conn.ConnectionString
        Me.FillListView()
    End Sub

    Private Sub frmSEARCH_CLIENT_RECEIPT_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        Me.asNum.EnterTab(e)
    End Sub
#End Region

#Region "TextBox Control"
    Private Sub Txt_GotFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtClient.GotFocus, TxtDateFrom.GotFocus, TxtDateTo.GotFocus
        CType(sender, TextBox).BackColor = Color.LightSteelBlue
        CType(sender, TextBox).SelectAll()
    End Sub
    Private Sub Txt_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtClient.LostFocus, TxtDateFrom.LostFocus, TxtDateTo.LostFocus
...
#Region "ListView Control"
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        ...
        If Not Me.ListView1.SelectedItems(0).Text = Nothing Then
            If Me.ListView1.SelectedItems(0).SubItems(6).Text = "BOUNCED" Or Me.ListView1.SelectedItems(0).SubItems(6).Text = "CANCELLED" Then

                MsgBox("Entry having 'BOUNCED/CANCELLED' Status, Update/Delete not allowed", MsgBoxStyle.Exclamation, "(NS) - Bound Alert!")

            Else
                My.Forms.frmCLIENT_RECEIPT.LblID.Text = Me.ListView1.SelectedItems(0).Text

                My.Forms.frmCLIENT_RECEIPT.BttnSave.Enabled = True
                Me.Close()
...
#Region "Button Control"
    Private Sub BttnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttnSearch.Click
        ...
        If Not Me.TxtClient.Text = Nothing And Me.TxtDateFrom.Text = Nothing And Me.TxtDateTo.Text = Nothing Then
            Str2 = "SELECT ID, CLIENT_ID, CLIENT_NAME, SHOP_NAME, R_DATE, CONVERT(NUMERIC(18,2),CASH_AMT) AS CASH_AMT, CHEQ_NO, CHEQ_TYPE, CHEQ_DATE, CONVERT(NUMERIC(18,2), BANK_AMT) AS BANK_AMT, SINV_NO, CASE CHEQ_STATUS WHEN '1' THEN 'STAND BY' WHEN '2' THEN 'DEPOSITED' WHEN '3' THEN 'CLEARED' WHEN '4' THEN 'BOUNCED' WHEN '5' THEN 'CANCELLED' END AS CHEQ_STATUS, STATUS_DATE, STATUS_DESC, BANK_ACC, BANK_NAME, EMP_NAME, USER_NAME, GROUP_NAME, DESCRIPTION, TOT_RECEIPT, GROUP_ID FROM V_CLIENT_RECEIPT WHERE CLIENT_NAME LIKE '%" & Me.TxtClient.Text & "%' ORDER BY ID DESC"

            Me.FillListView_Condition()

        ElseIf Not Me.TxtDateFrom.Text = Nothing And Not Me.TxtDateTo.Text = Nothing And Me.TxtClient.Text = Nothing Then
            Str2 = "SELECT ID, CLIENT_ID, CLIENT_NAME, SHOP_NAME, R_DATE, CONVERT(NUMERIC(18,2),CASH_AMT) AS CASH_AMT, CHEQ_NO, CHEQ_TYPE, CHEQ_DATE, CONVERT(NUMERIC(18,2), BANK_AMT) AS BANK_AMT, SINV_NO, CASE CHEQ_STATUS WHEN '1' THEN 'STAND BY' WHEN '2' THEN 'DEPOSITED' WHEN '3' THEN 'CLEARED' WHEN '4' THEN 'BOUNCED' WHEN '5' THEN 'CANCELLED' END AS CHEQ_STATUS, STATUS_DATE, STATUS_DESC, BANK_ACC, BANK_NAME, EMP_NAME, USER_NAME, GROUP_NAME, DESCRIPTION, TOT_RECEIPT, GROUP_ID FROM V_CLIENT_RECEIPT WHERE R_DATE>= CONVERT(DATETIME, '" & Me.TxtDateFrom.Text & "') AND R_DATE<= CONVERT(DATETIME, '" & Me.TxtDateTo.Text & "') ORDER BY ID DESC"
            Me.FillListView_Condition()

        ElseIf Not Me.TxtClient.Text = Nothing And Not Me.TxtDateFrom.Text = Nothing And Not Me.TxtDateTo.Text = Nothing Then
            Str2 = "SELECT ID, CLIENT_ID, CLIENT_NAME, SHOP_NAME, R_DATE, CONVERT(NUMERIC(18,2),CASH_AMT) AS CASH_AMT, CHEQ_NO, CHEQ_TYPE, CHEQ_DATE, CONVERT(NUMERIC(18,2), BANK_AMT) AS BANK_AMT, SINV_NO, CASE CHEQ_STATUS WHEN '1' THEN 'STAND BY' WHEN '2' THEN 'DEPOSITED' WHEN '3' THEN 'CLEARED' WHEN '4' THEN 'BOUNCED' WHEN '5' THEN 'CANCELLED' END AS CHEQ_STATUS, STATUS_DATE, STATUS_DESC, BANK_ACC, BANK_NAME, EMP_NAME, USER_NAME, GROUP_NAME, DESCRIPTION, TOT_RECEIPT, GROUP_ID FROM V_CLIENT_RECEIPT WHERE CLIENT_NAME LIKE '%" & Me.TxtClient.Text & "%' AND R_DATE>= CONVERT(DATETIME, '" & Me.TxtDateFrom.Text & "') AND R_DATE<= CONVERT(DATETIME, '" & Me.TxtDateTo.Text & "') ORDER BY ID DESC"
            Me.FillListView_Condition()
...
#Region "Sub and Functions"
    Private Sub FillListView()
        Try
            ...
            Dim Str1 As String = "SELECT ID, CLIENT_ID, CLIENT_NAME, SHOP_NAME, R_DATE, CONVERT(NUMERIC(18,2),CASH_AMT) AS CASH_AMT, CHEQ_NO, CHEQ_TYPE, CHEQ_DATE, CONVERT(NUMERIC(18,2), BANK_AMT) AS BANK_AMT, SINV_NO, CASE CHEQ_STATUS WHEN '1' THEN 'STAND BY' WHEN '2' THEN 'DEPOSITED' WHEN '3' THEN 'CLEARED' WHEN '4' THEN 'BOUNCED' WHEN '5' THEN 'CANCELLED' END AS CHEQ_STATUS, STATUS_DATE, STATUS_DESC, BANK_ACC, BANK_NAME, EMP_NAME, USER_NAME, GROUP_NAME, DESCRIPTION, TOT_RECEIPT, GROUP_ID FROM V_CLIENT_RECEIPT ORDER BY ID DESC"
            ...
            For Cnt = 0 To Me.DsCLIENT_RECEIPT1.V_CLIENT_RECEIPT.Count - 1
                LstItem = Me.ListView1.Items.Add(Me.DsCLIENT_RECEIPT1.V_CLIENT_RECEIPT.Item(Cnt).Item(0).ToString)
                Me.ListView1.Items(Cnt).UseItemStyleForSubItems = False
                With LstItem.SubItems

                    .Add(Me.DsCLIENT_RECEIPT1.V_CLIENT_RECEIPT.Item(Cnt).Item(2).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    Dim dDATE As String = Me.DsCLIENT_RECEIPT1.V_CLIENT_RECEIPT.Item(Cnt).Item(4).ToString

                    If dDATE.Length > 0 Then
                        .Add(CDate(dDATE).ToString("dd-MMM-yyyy"), Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    Else
                        .Add(Me.DsCLIENT_RECEIPT1.V_CLIENT_RECEIPT.Item(Cnt).Item(3).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    End If

                    .Add(Me.DsCLIENT_RECEIPT1.V_CLIENT_RECEIPT.Item(Cnt).Item(5).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    .Add(Me.DsCLIENT_RECEIPT1.V_CLIENT_RECEIPT.Item(Cnt).Item(9).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
                    .Add(Me.DsCLIENT_RECEIPT1.V_CLIENT_RECEIPT.Item(Cnt).Item(14).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)

                    Dim CHQ_STATUS As String = Me.DsCLIENT_RECEIPT1.V_CLIENT_RECEIPT.Item(Cnt).Item(11).ToString

                    If CHQ_STATUS = "STAND BY" Or CHQ_STATUS = "DEPOSITED" Or CHQ_STATUS = "CLEARED" Then
                        .Add(CHQ_STATUS, Color.Black, Me.ListView1.BackColor, Me.ListView1.Font)

                    ElseIf CHQ_STATUS = "BOUNCED" Or CHQ_STATUS = "CANCELLED" Then
                        .Add(CHQ_STATUS, Color.White, Color.Red, Me.ListView1.Font)

                    Else
                        .Add(Me.DsCLIENT_RECEIPT1.V_CLIENT_RECEIPT.Item(Cnt).Item(11).ToString, Color.Black, Me.ListView1.BackColor, Me.ListView1.Font)
                    End If
    ...
    Private Sub FillListView_Condition()
        Try
            ...
            Me.daCLIENT_RECEIPT = New SDS.SqlDataAdapter(SqlCmd2)
