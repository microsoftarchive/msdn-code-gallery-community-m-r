...
#Region "FORM CONTROL"
    ...
    Private Sub frmSINV_RECEIPT_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Me.TxtCashPmt.Focus()
    End Sub
    Private Sub frmSINV_RECEIPT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '        On Error GoTo Fix
        '        Me.CmbBankAccount.SelectedIndex = Me.CmbBankAccount.FindString(Me.BnkACC)

        'Fix:
    End Sub

    Private Sub frmSINV_RECEIPT_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        Me.asNum.EnterTab(e)
    End Sub
#End Region
...
#Region "TextBox Control"
    ...
    '    'frmSALE.TxtReceipt.Text = Val(Me.TxtCashPmt.Text) + Val(Me.TxtBankPmt.Text)
    '    '        On Error GoTo Fix
    ...
    Private Sub BttnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttnSave.Click
        ...
        If Val(Me.TxtBankPmt.Text) > 0 And Val(Me.TxtCashPmt.Text) <= 0 Then
            ...
            ElseIf MsgBox("Do you want to save BANK: '" & Me.TxtBankPmt.Text & "'", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "(NS) - Save?") = MsgBoxResult.Yes Then
                frmSALE.TxtReceipt.Text = Val(Me.TxtBankPmt.Text)
                frmSALE.BANK_AMT = Val(Me.TxtBankPmt.Text)

                frmSALE.BANK_ACC = Me.CmbBankAccount.SelectedItem.Col1
                frmSALE.CHEQ_TYPE = Me.TxtChequeType.Text
                frmSALE.CHEQ_NO = Me.TxtChequeNo.Text
                frmSALE.CHEQ_DATE = Me.TxtChequeDate.Text
                frmSALE.DESCRIPTION = Me.TxtDescription.Text

                frmSALE.BttnSave.Focus()

                frmSALE.BANK_PAY = True

                frmSALE.CASH_PAY = False
                frmSALE.BOTH_PAY = False
        ...
        ElseIf Val(Me.TxtBankPmt.Text) <= 0 And Val(Me.TxtCashPmt.Text) > 0 Then
            If MsgBox("Do you want to save CASH: '" & Me.TxtCashPmt.Text & "'", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "(NS) - Save?") = MsgBoxResult.Yes Then
                frmSALE.TxtReceipt.Text = Val(Me.TxtCashPmt.Text)
                frmSALE.CASH_AMT = Val(Me.TxtCashPmt.Text)
                frmSALE.DESCRIPTION = Me.TxtDescription.Text

                frmSALE.BttnSave.Focus()

                frmSALE.CASH_PAY = True

                frmSALE.BANK_PAY = False
                frmSALE.BOTH_PAY = False
