...
Public Class frmSUPPLIER_RECEIPT
...
#Region "FORM CONTROL"
    Private Sub frmSUPPLIER_RECEIPT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.CmbReceiptType.SelectedIndex = 0
    ...
    Private Sub frmSUPPLIER_RECEIPT_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        Me.asNum.EnterTab(e)
    End Sub
#End Region
...
#Region "Lable Control"
    Private Sub LblID_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LblID.TextChanged
        If Me.LblID.Text.Length > 0 Then
            ...
            StrCmb = Me.CmbReceiptType.Text
            Me.CmbReceiptType.SelectedIndex = -1
            Me.CmbReceiptType.SelectedIndex = Me.CmbReceiptType.FindString(StrCmb)
...
#Region "ComboBox Controls"
    'Got and LostFocus
    Private Sub Cmb_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmbEmployee.GotFocus, CmbGroup.GotFocus, CmbBankAccount.GotFocus, CmbReceiptType.GotFocus
        CType(sender, ComboBox).BackColor = Color.LightSteelBlue
        CType(sender, ComboBox).SelectAll()
    End Sub
    Private Sub Cmb_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmbEmployee.LostFocus, CmbGroup.LostFocus, CmbBankAccount.LostFocus, CmbReceiptType.LostFocus
...
#Region "Button Control"
    ...
    Private Sub BttnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttnSearch.Click
        My.Forms.frmSEARCH_SUPPLIER_RECEIPT.ShowDialog(Me)
    End Sub

    Private Sub BttnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttnSave.Click
        If Not Val(Me.LblID.Text) > 0 Then
            'FOR INSERT RECORD IN CLIENT RECEIPT
            If Me.TxtDate.Text = Nothing Or Me.CmbReceiptType.Text = Nothing Or Me.CmbReceiptType.SelectedIndex = -1 Or Me.CmbEmployee.SelectedIndex = -1 Or Me.CmbEmployee.Text = Nothing Or Me.CmbGroup.SelectedIndex = -1 Or Me.CmbGroup.Text = Nothing Or Me.CmbSupplier.SelectedIndex = -1 Or Me.CmbSupplier.Text = Nothing Then
                ...
                ElseIf Me.CmbReceiptType.Text = Nothing Or Me.CmbReceiptType.SelectedIndex = -1 Then
                    Me.CmbReceiptType.Focus()
            ...
            ElseIf Val(Me.TxtBankPmt.Text) > 0 And Val(Me.TxtCashPmt.Text) <= 0 Then
                ...
                ElseIf MsgBox("Do you want to save in BANK: '" & Me.TxtBankPmt.Text & "'", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "(NS) - Save?") = MsgBoxResult.Yes Then
                    Me.asInsert.SaveValueIN("INSERT INTO SUPPLIER_RECEIPT(nSUPPLIER_ID, dDATE, sCHEQUE_NO, sCHEQUE_TYPE, dCHEQUE_DATE, nCHECK_AMOUNT, sACCOUNT_CODE, nRECEIPT_TYPE, nEMP_CODE, nLOGIN_ID, nBUSINESS_CODE, sDESCRIPTON) VALUES(" & Val(Me.CmbSupplier.SelectedItem.Col3) & ", '" & CDate(Me.TxtDate.Text).ToString("MM-dd-yyyy") & "', '" & Me.TxtChequeNo.Text & "', '" & Me.TxtChequeType.Text & "', '" & CDate(Me.TxtChequeDate.Text).ToString("MM-dd-yyyy") & "', " & Val(Me.TxtBankPmt.Text) & ",'" & Me.CmbBankAccount.SelectedItem.Col1 & "'," & Me.CmbReceiptType.SelectedIndex & ", " & Val(Me.CmbEmployee.SelectedItem.Col3) & ",10," & Val(Me.CmbGroup.SelectedItem.Col3) & ",'" & Me.TxtDescription.Text & "')")
            ...
            ElseIf Val(Me.TxtBankPmt.Text) <= 0 And Val(Me.TxtCashPmt.Text) > 0 Then
                If MsgBox("Do you want to save CASH: '" & Me.TxtCashPmt.Text & "'", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "(NS) - Save?") = MsgBoxResult.Yes Then
                    Me.asInsert.SaveValueIN("INSERT INTO SUPPLIER_RECEIPT(nSUPPLIER_ID, dDATE, nCASH_AMOUNT, nRECEIPT_TYPE, nEMP_CODE, nLOGIN_ID, nBUSINESS_CODE,sDESCRIPTON) VALUES(" & Val(Me.CmbSupplier.SelectedItem.Col3) & ",'" & CDate(Me.TxtDate.Text).ToString("MM-dd-yyyy") & "'," & Val(Me.TxtCashPmt.Text) & ", " & Me.CmbReceiptType.SelectedIndex & ", " & Val(Me.CmbEmployee.SelectedItem.Col3) & ",10," & Val(Me.CmbGroup.SelectedItem.Col3) & ",'" & Me.TxtDescription.Text & "')")
                    Me.BttnSave.Enabled = False
                    Me.BttnNew.Focus()
            ...
            ElseIf Val(Me.TxtBankPmt.Text) > 0 And Val(Me.TxtCashPmt.Text) > 0 Then
                ...
                ElseIf MsgBox("Do you want to save CASH: '" & Me.TxtCashPmt.Text & "' & BANK: '" & Me.TxtBankPmt.Text & "'", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "(NS) - Save?") = MsgBoxResult.Yes Then
                    Me.asInsert.SaveValueIN("INSERT INTO SUPPLIER_RECEIPT(nSUPPLIER_ID, dDATE, nCASH_AMOUNT, sCHEQUE_NO,sCHEQUE_TYPE, dCHEQUE_DATE, nCHECK_AMOUNT, sACCOUNT_CODE, nRECEIPT_TYPE, nEMP_CODE, nLOGIN_ID, nBUSINESS_CODE,sDESCRIPTON) VALUES(" & Val(Me.CmbSupplier.SelectedItem.Col3) & ", '" & CDate(Me.TxtDate.Text).ToString("MM-dd-yyyy") & "', " & Val(Me.TxtCashPmt.Text) & ", '" & Me.TxtChequeNo.Text & "', '" & Me.TxtChequeType.Text & "', '" & CDate(Me.TxtChequeDate.Text).ToString("MM-dd-yyyy") & "', " & Val(Me.TxtBankPmt.Text) & ",'" & Me.CmbBankAccount.SelectedItem.Col1 & "', " & Me.CmbReceiptType.SelectedIndex & ", " & Val(Me.CmbEmployee.SelectedItem.Col3) & ",10," & Val(Me.CmbGroup.SelectedItem.Col3) & ",'" & Me.TxtDescription.Text & "')")
                    Me.BttnSave.Enabled = False
                    Me.BttnNew.Focus()
                End If
        ...
        ElseIf Val(Me.LblID.Text) > 0 Then
            ...
            ElseIf Val(Me.TxtBankPmt.Text) > 0 And Val(Me.TxtCashPmt.Text) <= 0 Then
                ...
                ElseIf MsgBox("Do you want to update in BANK: '" & Me.TxtBankPmt.Text & "'", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "(NS) - Update?") = MsgBoxResult.Yes Then
                    Me.asUpdate.UpdateValueIN("UPDATE SUPPLIER_RECEIPT SET nSUPPLIER_ID=" & Val(Me.CmbSupplier.SelectedItem.Col3) & ", dDATE='" & CDate(Me.TxtDate.Text).ToString("MM-dd-yyyy") & "', sCHEQUE_NO='" & Me.TxtChequeNo.Text & "', sCHEQUE_TYPE='" & Me.TxtChequeType.Text & "', dCHEQUE_DATE='" & CDate(Me.TxtChequeDate.Text).ToString("MM-dd-yyyy") & "', nCHECK_AMOUNT=" & Val(Me.TxtBankPmt.Text) & ", sACCOUNT_CODE='" & Me.CmbBankAccount.SelectedItem.Col1 & "', nRECEIPT_TYPE=" & Me.CmbReceiptType.SelectedIndex & ", nEMP_CODE=" & Val(Me.CmbEmployee.SelectedItem.Col3) & ", nLOGIN_ID=10, nBUSINESS_CODE=" & Val(Me.CmbGroup.SelectedItem.Col3) & ", sDESCRIPTON='" & Me.TxtDescription.Text & "', nCASH_AMOUNT=0 WHERE nID=" & Val(Me.LblID.Text) & "")
                    Me.BttnSave.Enabled = False
                    Me.BttnNew.Focus()
            ...
            ElseIf Val(Me.TxtBankPmt.Text) <= 0 And Val(Me.TxtCashPmt.Text) > 0 Then
                If MsgBox("Do you want to update CASH: '" & Me.TxtCashPmt.Text & "'", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "(NS) - Update?") = MsgBoxResult.Yes Then
                    Me.asUpdate.UpdateValueIN("UPDATE SUPPLIER_RECEIPT SET nSUPPLIER_ID=" & Val(Me.CmbSupplier.SelectedItem.Col3) & ", dDATE='" & CDate(Me.TxtDate.Text).ToString("MM-dd-yyyy") & "', sCHEQUE_NO=NULL, sCHEQUE_TYPE=NULL, dCHEQUE_DATE=NULL, nCHECK_AMOUNT=0, sACCOUNT_CODE=NULL, nRECEIPT_TYPE=" & Me.CmbReceiptType.SelectedIndex & ", nEMP_CODE=" & Val(Me.CmbEmployee.SelectedItem.Col3) & ", nLOGIN_ID=10, nBUSINESS_CODE=" & Val(Me.CmbGroup.SelectedItem.Col3) & ", sDESCRIPTON='" & Me.TxtDescription.Text & "', nCASH_AMOUNT=" & Val(Me.TxtCashPmt.Text) & " WHERE nID=" & Val(Me.LblID.Text) & "")
                    Me.BttnSave.Enabled = False
                    Me.BttnNew.Focus()
    ...
    Private Sub BttnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttnDelete.Click
        If MsgBox("Are you sure to Delete this Receipt Record?", MsgBoxStyle.Critical + vbYesNo, "(NS) - Deletion!") = MsgBoxResult.Yes Then
            Me.asDelete.DeleteValue("DELETE FROM SUPPLIER_RECEIPT WHERE nID=" & Val(Me.LblID.Text) & "")
            Me.LblID.Text = Nothing
        End If
    End Sub
#End Region
