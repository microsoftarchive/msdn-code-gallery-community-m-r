...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmLUP_SHOP_CAT))
        ...
        Me.BttnPrevForm.Size = New System.Drawing.Size(97, 45)
        Me.BttnPrevForm.TabIndex = 17
        Me.BttnPrevForm.TabStop = False
        Me.BttnPrevForm.Text = "Client Grades"
        ...
        Me.BttnNextForm.Location = New System.Drawing.Point(383, 7)
        Me.BttnNextForm.Name = "BttnNextForm"
        Me.BttnNextForm.Size = New System.Drawing.Size(97, 45)
        Me.BttnNextForm.TabIndex = 16
        Me.BttnNextForm.TabStop = False
        Me.BttnNextForm.Text = "Client Information"
        ...
        Me.Label3.Text = "SHOP CATEGORIES"
        ...
        'ColumnHeader2
        '
        Me.ColumnHeader2.Text = "CAT NAME(s)"
        ...
        Me.KeyPreview = True
        Me.Name = "frmLUP_SHOP_CAT"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "SHOP CATEGORY"
...
#Region "FORM CONTROL"
    Private Sub frmLUP_SHOP_CAT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.SqlConnection1.ConnectionString = Me.asConn.Conn.ConnectionString
        Me.FillListView()
    End Sub

    Private Sub frmLUP_SHOP_CAT_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        asNum.EnterTab(e)
    End Sub
#End Region
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        ...
        If Not Me.ListView1.SelectedItems(0).Text = Nothing Then
            If MsgBox("Do you want to DELETE '" & Me.ListView1.SelectedItems(0).SubItems(1).Text & "' From Record?", MsgBoxStyle.Critical + vbYesNo, "(NS) - Confirm Delete!") = MsgBoxResult.Yes Then
                Me.asDelete.DeleteValueIN("DELETE FROM LUP_SHOP_CAT WHERE nCODE=" & Val(Me.ListView1.SelectedItems(0).Text) & "")
    ...
    Private Sub BttnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttnSave.Click
        ...
        ElseIf Me.TxtCode.Text = Nothing Then
            If MsgBox("Do you want to save '" & Me.TxtDESC.Text & "'", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Save?") = MsgBoxResult.Yes Then
                'INSERT VALUES
                Me.asInsert.SaveValueIN("INSERT INTO LUP_SHOP_CAT(sDESC) VALUES('" & Me.TxtDESC.Text & "') ")
        ...
        ElseIf Not Me.TxtCode.Text = Nothing Then
            If MsgBox("Do you want to update '" & Me.TxtDESC.Text & "'", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Update?") = MsgBoxResult.Yes Then
                'UPDATE RECORD
                Me.asUpdate.UpdateValueIN("UPDATE LUP_SHOP_CAT SET sDESC='" & Me.TxtDESC.Text & "' WHERE nCODE=" & Val(Me.TxtCode.Text) & "")
                'FILL THE RECORD IN LISTVIEW
                Me.FillListView()
                Me.TxtDESC.Focus()
            End If
...
#Region "Sub and Functions"
    Private Sub FillListView()
        ...
        Try
            ...
            For Cnt = 0 To Me.DsLUP_SHOP_CAT1.LUP_SHOP_CAT.Count - 1
                LstItem = Me.ListView1.Items.Add(Me.DsLUP_SHOP_CAT1.LUP_SHOP_CAT.Item(Cnt).Item(0).ToString)
                Me.ListView1.Items(Cnt).UseItemStyleForSubItems = False
                With LstItem.SubItems

                    .Add(Me.DsLUP_SHOP_CAT1.LUP_SHOP_CAT.Item(Cnt).Item(1).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
    ...
    Private Sub FillListView_Condition()
        ...
        Try
            Dim Str1 As String = "SELECT nCODE, sDESC FROM LUP_SHOP_CAT WHERE sDESC LIKE '%" & Me.TxtSearch.Text & "%' ORDER BY sDESC"
            Dim SqlCmd1 As New SDS.SqlCommand(Str1, Me.SqlConnection1)
            Me.daLUP_SHOP_CAT = New SDS.SqlDataAdapter(SqlCmd1)
