...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.BttnNextForm.TabIndex = 26
        Me.BttnNextForm.TabStop = False
        Me.BttnNextForm.Text = "Item Categories"
        ...
        Me.BttnPrevForm.TabIndex = 25
        Me.BttnPrevForm.TabStop = False
        Me.BttnPrevForm.Text = "Supplier Open Bal"
        ...
        Me.Label3.Text = "COMPANIES DETAIL"
        ...
        'ColumnHeader2
        '
        Me.ColumnHeader2.Text = "Companies"
...
#Region "FORM CONTROL"
    Private Sub frmLUP_VENDORS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.SqlConnection1.ConnectionString = Me.asConn.Conn.ConnectionString
        Me.FillListView()
    End Sub

    Private Sub frmLUP_VENDORS_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        asNum.EnterTab(e)
    End Sub
#End Region
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        ...
        If Not Me.ListView1.SelectedItems(0).Text = Nothing Then
            If MsgBox("Do you want to DELETE '" & Me.ListView1.SelectedItems(0).SubItems(1).Text & "' From Record?", MsgBoxStyle.Critical + vbYesNo, "(NS) - Confirm Delete!") = MsgBoxResult.Yes Then
                Me.asDelete.DeleteValueIN("DELETE FROM LUP_VENDOR WHERE nCODE=" & Val(Me.ListView1.SelectedItems(0).Text) & "")
    ...
    Private Sub BttnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttnSave.Click
        ...
        ElseIf Me.TxtCode.Text = Nothing Then
            If MsgBox("Do you want to save '" & Me.TxtDESC.Text & "'", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Save?") = MsgBoxResult.Yes Then
                'INSERT VALUES
                Me.asInsert.SaveValueIN("INSERT INTO LUP_VENDOR(sDESC) VALUES('" & Me.TxtDESC.Text & "') ")
        ...
        ElseIf Not Me.TxtCode.Text = Nothing Then
            If MsgBox("Do you want to update '" & Me.TxtDESC.Text & "'", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Update?") = MsgBoxResult.Yes Then
                'UPDATE RECORD
                Me.asUpdate.UpdateValueIN("UPDATE LUP_VENDOR SET sDESC='" & Me.TxtDESC.Text & "' WHERE nCODE=" & Val(Me.TxtCode.Text) & "")
                'FILL THE RECORD IN LISTVIEW
                Me.FillListView()
                Me.TxtDESC.Focus()
            End If
...
#Region "Sub and Functions"
    Private Sub FillListView()
        ...
        Try
            ...
            For Cnt = 0 To Me.DsLUP_VENDOR1.LUP_VENDOR.Count - 1
                LstItem = Me.ListView1.Items.Add(Me.DsLUP_VENDOR1.LUP_VENDOR.Item(Cnt).Item(0).ToString)
                Me.ListView1.Items(Cnt).UseItemStyleForSubItems = False
                With LstItem.SubItems

                    .Add(Me.DsLUP_VENDOR1.LUP_VENDOR.Item(Cnt).Item(1).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
    ...
    Private Sub FillListView_Condition()
        ...
        Try
            Dim Str1 As String = "SELECT nCODE, sDESC FROM LUP_VENDOR WHERE sDESC LIKE '%" & Me.TxtSearch.Text & "%' ORDER BY sDESC"
            Dim SqlCmd1 As New SDS.SqlCommand(Str1, Me.SqlConnection1)
            Me.daLUP_VENDOR = New SDS.SqlDataAdapter(SqlCmd1)
