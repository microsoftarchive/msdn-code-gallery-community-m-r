...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.BttnPrevForm.TabIndex = 11
        Me.BttnPrevForm.TabStop = False
        Me.BttnPrevForm.Text = "Route(s) Detail"
        ...
        Me.BttnNextForm.TabIndex = 10
        Me.BttnNextForm.TabStop = False
        Me.BttnNextForm.Text = "Expense Detail"
        ...
        'ColumnHeader2
        '
        Me.ColumnHeader2.Text = "EXPENSE(s)"
        ...
        Me.KeyPreview = True
        Me.Name = "frmLUP_EXPENSES"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "EXPENSE HEADS"
...
#Region "FORM CONTROL"
    Private Sub frmLUP_EXPENSES_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.SqlConnection1.ConnectionString = Me.asConn.Conn.ConnectionString
        Me.FillListView()
    End Sub

    Private Sub frmLUP_EXPENSES_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        asNum.EnterTab(e)
    End Sub
#End Region
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        ...
        If Not Me.ListView1.SelectedItems(0).Text = Nothing Then
            If MsgBox("Do you want to DELETE '" & Me.ListView1.SelectedItems(0).SubItems(1).Text & "' From Record?", MsgBoxStyle.Critical + vbYesNo, "(NS) - Confirm Delete!") = MsgBoxResult.Yes Then
                Me.asDelete.DeleteValueIN("DELETE FROM LUP_EXPENSE_MAIN_HEAD WHERE nCODE=" & Val(Me.ListView1.SelectedItems(0).Text) & "")
    ...
    Private Sub BttnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttnSave.Click
        ...
        ElseIf Me.TxtCode.Text = Nothing Then
            If MsgBox("Do you want to save '" & Me.TxtDESC.Text & "'", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Save?") = MsgBoxResult.Yes Then
                'INSERT VALUES
                Me.asInsert.SaveValueIN("INSERT INTO LUP_EXPENSE_MAIN_HEAD(sDESC) VALUES('" & Me.TxtDESC.Text & "') ")
        ...
        ElseIf Not Me.TxtCode.Text = Nothing Then
            If MsgBox("Do you want to update '" & Me.TxtDESC.Text & "'", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Update?") = MsgBoxResult.Yes Then
                'UPDATE RECORD
                Me.asUpdate.UpdateValueIN("UPDATE LUP_EXPENSE_MAIN_HEAD SET sDESC='" & Me.TxtDESC.Text & "' WHERE nCODE=" & Val(Me.TxtCode.Text) & "")
                'FILL THE RECORD IN LISTVIEW
                Me.FillListView()
                Me.TxtDESC.Focus()
            End If
...
#Region "Sub and Functions"
    Private Sub FillListView()
        ...
        Try
            ...
            For Cnt = 0 To Me.DsLUP_EXPENSES1.LUP_EXPENSE_MAIN_HEAD.Count - 1
                LstItem = Me.ListView1.Items.Add(Me.DsLUP_EXPENSES1.LUP_EXPENSE_MAIN_HEAD.Item(Cnt).Item(0).ToString)
                Me.ListView1.Items(Cnt).UseItemStyleForSubItems = False
                With LstItem.SubItems

                    .Add(Me.DsLUP_EXPENSES1.LUP_EXPENSE_MAIN_HEAD.Item(Cnt).Item(1).ToString, Color.DarkBlue, Me.ListView1.BackColor, Me.ListView1.Font)
    ...
    Private Sub FillListView_Condition()
        ...
        Try
            Dim Str1 As String = "SELECT nCODE, sDESC FROM LUP_EXPENSE_MAIN_HEAD WHERE sDESC LIKE '%" & Me.TxtSearch.Text & "%' ORDER BY sDESC"
            Dim SqlCmd1 As New SDS.SqlCommand(Str1, Me.SqlConnection1)
            Me.daLUP_EXPENSES = New SDS.SqlDataAdapter(SqlCmd1)
