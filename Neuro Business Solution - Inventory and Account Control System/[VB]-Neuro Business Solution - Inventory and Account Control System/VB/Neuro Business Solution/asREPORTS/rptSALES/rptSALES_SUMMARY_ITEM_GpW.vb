...
Public Class rptSALES_SUMMARY_ITEM_GpW
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSALES_SUMMARY_ITEM_GpW.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSALES_SUMMARY_ITEM_GpW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSALES_SUMMARY_ITEM_GpW = New rptSALES_SUMMARY_ITEM_GpW
        rpt.Site = Me.Site
        Return rpt
    End Function
