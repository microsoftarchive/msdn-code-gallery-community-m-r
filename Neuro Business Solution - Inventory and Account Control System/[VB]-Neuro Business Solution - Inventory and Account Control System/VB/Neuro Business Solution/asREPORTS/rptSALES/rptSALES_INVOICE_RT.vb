...
Public Class rptSALES_INVOICE_RT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSALES_INVOICE_RT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSALES_INVOICE_RT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSALES_INVOICE_RT = New rptSALES_INVOICE_RT
        rpt.Site = Me.Site
        Return rpt
    End Function
