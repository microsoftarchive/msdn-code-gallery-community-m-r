...
Public Class rptSALES_INVOICE_NO_WS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSALES_INVOICE_NO_WS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSALES_INVOICE_NO_WS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSALES_INVOICE_NO_WS = New rptSALES_INVOICE_NO_WS
        rpt.Site = Me.Site
        Return rpt
    End Function
