...
Public Class rptLOADPASS_INVOICE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLOADPASS_INVOICE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLOADPASS_INVOICE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLOADPASS_INVOICE = New rptLOADPASS_INVOICE
        rpt.Site = Me.Site
        Return rpt
    End Function
