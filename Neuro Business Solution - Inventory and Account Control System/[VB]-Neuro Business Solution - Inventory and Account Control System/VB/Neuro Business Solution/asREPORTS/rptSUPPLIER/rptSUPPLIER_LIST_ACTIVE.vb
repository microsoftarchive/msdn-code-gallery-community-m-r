...
Public Class rptSUPPLIER_LIST_ACTIVE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSUPPLIER_LIST_ACTIVE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSUPPLIER_LIST_ACTIVE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSUPPLIER_LIST_ACTIVE = New rptSUPPLIER_LIST_ACTIVE
        rpt.Site = Me.Site
        Return rpt
    End Function
