...
Public Class rptSUPPLIER_RECEIPTS_HISTORY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSUPPLIER_RECEIPTS_HISTORY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSUPPLIER_RECEIPTS_HISTORY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSUPPLIER_RECEIPTS_HISTORY = New rptSUPPLIER_RECEIPTS_HISTORY
        rpt.Site = Me.Site
        Return rpt
    End Function
