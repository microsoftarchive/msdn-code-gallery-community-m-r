...
Public Class rptSUPPLIER_CREDIT_REPORT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSUPPLIER_CREDIT_REPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSUPPLIER_CREDIT_REPORT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSUPPLIER_CREDIT_REPORT = New rptSUPPLIER_CREDIT_REPORT
        rpt.Site = Me.Site
        Return rpt
    End Function
