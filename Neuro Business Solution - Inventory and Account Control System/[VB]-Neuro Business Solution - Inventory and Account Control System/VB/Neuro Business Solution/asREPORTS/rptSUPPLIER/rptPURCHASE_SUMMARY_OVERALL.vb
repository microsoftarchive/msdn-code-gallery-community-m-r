...
Public Class rptPURCHASE_SUMMARY_OVERALL
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPURCHASE_SUMMARY_OVERALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPURCHASE_SUMMARY_OVERALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPURCHASE_SUMMARY_OVERALL = New rptPURCHASE_SUMMARY_OVERALL
        rpt.Site = Me.Site
        Return rpt
    End Function
