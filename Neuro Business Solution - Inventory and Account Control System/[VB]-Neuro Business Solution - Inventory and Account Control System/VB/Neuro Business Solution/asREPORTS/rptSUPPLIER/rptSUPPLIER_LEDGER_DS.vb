...
Public Class rptSUPPLIER_LEDGER_DS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSUPPLIER_LEDGER_DS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSUPPLIER_LEDGER_DS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSUPPLIER_LEDGER_DS = New rptSUPPLIER_LEDGER_DS
        rpt.Site = Me.Site
        Return rpt
    End Function
