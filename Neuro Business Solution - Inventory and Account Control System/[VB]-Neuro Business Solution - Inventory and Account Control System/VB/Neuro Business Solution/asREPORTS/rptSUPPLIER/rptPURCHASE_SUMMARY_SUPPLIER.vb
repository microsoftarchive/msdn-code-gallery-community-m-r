...
Public Class rptPURCHASE_SUMMARY_SUPPLIER
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPURCHASE_SUMMARY_SUPPLIER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPURCHASE_SUMMARY_SUPPLIER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPURCHASE_SUMMARY_SUPPLIER = New rptPURCHASE_SUMMARY_SUPPLIER
        rpt.Site = Me.Site
        Return rpt
    End Function
