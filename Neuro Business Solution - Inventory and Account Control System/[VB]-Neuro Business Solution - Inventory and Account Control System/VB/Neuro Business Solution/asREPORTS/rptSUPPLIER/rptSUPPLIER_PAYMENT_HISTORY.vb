...
Public Class rptSUPPLIER_PAYMENT_HISTORY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSUPPLIER_PAYMENT_HISTORY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSUPPLIER_PAYMENT_HISTORY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSUPPLIER_PAYMENT_HISTORY = New rptSUPPLIER_PAYMENT_HISTORY
        rpt.Site = Me.Site
        Return rpt
    End Function
