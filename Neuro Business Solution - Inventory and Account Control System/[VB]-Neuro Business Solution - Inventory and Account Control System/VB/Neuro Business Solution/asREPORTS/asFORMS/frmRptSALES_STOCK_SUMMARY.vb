Public Class frmRptSALES_STOCK_SUMMARY
    ...
    Private Sub BttnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttnView.Click
        ...
        Try
            If Me.RBttnInvoice.Checked = True Then
                Frm.STATUS = "SALES_STOCK_SUMMARY_INV"
                Frm.Text = "Sales Stock Summary No-to-No"
                Frm.PnlInvoice.Visible = True

            ElseIf Me.RBttnDate.Checked = True Then
                Frm.STATUS = "SALES_STOCK_SUMMARY_DATE"
                Frm.Text = "Sales Stock Summary Date Wise"
            ...
            ElseIf Me.RBttnArea_Date.Checked = True Then
                Frm.STATUS = "SALES_STOCK_SUMMARY_AREA_DATE"
                Frm.Text = "Sales Stock Summary Area and Date Wise"
