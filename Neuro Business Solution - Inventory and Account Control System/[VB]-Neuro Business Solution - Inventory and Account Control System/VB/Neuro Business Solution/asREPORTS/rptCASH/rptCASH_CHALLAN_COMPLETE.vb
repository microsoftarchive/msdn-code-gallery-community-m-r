...
Public Class rptCASH_CHALLAN_COMPLETE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCASH_CHALLAN_COMPLETE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCASH_CHALLAN_COMPLETE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCASH_CHALLAN_COMPLETE = New rptCASH_CHALLAN_COMPLETE
        rpt.Site = Me.Site
        Return rpt
    End Function
