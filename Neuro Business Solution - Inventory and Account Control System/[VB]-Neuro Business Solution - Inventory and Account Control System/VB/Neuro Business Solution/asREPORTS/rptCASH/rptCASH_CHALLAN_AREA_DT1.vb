...
Public Class rptCASH_CHALLAN_AREA_DT1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCASH_CHALLAN_AREA_DT1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCASH_CHALLAN_AREA_DT1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCASH_CHALLAN_AREA_DT1 = New rptCASH_CHALLAN_AREA_DT1
        rpt.Site = Me.Site
        Return rpt
    End Function
