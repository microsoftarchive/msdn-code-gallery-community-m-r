...
Public Class rptCASH_RECEIPT_HISTORY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCASH_RECEIPT_HISTORY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCASH_RECEIPT_HISTORY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCASH_RECEIPT_HISTORY = New rptCASH_RECEIPT_HISTORY
        rpt.Site = Me.Site
        Return rpt
    End Function
