...
Public Class rptRECOVERY_HISTORY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRECOVERY_HISTORY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRECOVERY_HISTORY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRECOVERY_HISTORY = New rptRECOVERY_HISTORY
        rpt.Site = Me.Site
        Return rpt
    End Function
