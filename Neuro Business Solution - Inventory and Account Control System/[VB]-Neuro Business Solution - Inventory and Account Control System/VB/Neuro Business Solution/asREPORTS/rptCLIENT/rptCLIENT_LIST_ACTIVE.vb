...
Public Class rptCLIENT_LIST_ACTIVE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCLIENT_LIST_ACTIVE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCLIENT_LIST_ACTIVE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCLIENT_LIST_ACTIVE = New rptCLIENT_LIST_ACTIVE
        rpt.Site = Me.Site
        Return rpt
    End Function
