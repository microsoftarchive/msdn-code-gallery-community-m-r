...
Public Class rptCLIENT_CREDIT_REPORT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCLIENT_CREDIT_REPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCLIENT_CREDIT_REPORT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCLIENT_CREDIT_REPORT = New rptCLIENT_CREDIT_REPORT
        rpt.Site = Me.Site
        Return rpt
    End Function
