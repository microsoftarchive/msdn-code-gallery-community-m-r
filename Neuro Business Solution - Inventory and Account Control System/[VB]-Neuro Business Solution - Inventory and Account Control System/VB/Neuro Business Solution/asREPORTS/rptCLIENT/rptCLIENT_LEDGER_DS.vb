...
Public Class rptCLIENT_LEDGER_DS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCLIENT_LEDGER_DS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCLIENT_LEDGER_DS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCLIENT_LEDGER_DS = New rptCLIENT_LEDGER_DS
        rpt.Site = Me.Site
        Return rpt
    End Function
