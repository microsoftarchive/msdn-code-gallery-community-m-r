...
Public Class rptCLIENT_CREDIT_REPORT_AREA
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCLIENT_CREDIT_REPORT_AREA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCLIENT_CREDIT_REPORT_AREA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCLIENT_CREDIT_REPORT_AREA = New rptCLIENT_CREDIT_REPORT_AREA
        rpt.Site = Me.Site
        Return rpt
    End Function
