...
Public Class rptSTOCK_HAND_COMPANY_DT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSTOCK_HAND_COMPANY_DT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSTOCK_HAND_COMPANY_DT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSTOCK_HAND_COMPANY_DT = New rptSTOCK_HAND_COMPANY_DT
        rpt.Site = Me.Site
        Return rpt
    End Function
