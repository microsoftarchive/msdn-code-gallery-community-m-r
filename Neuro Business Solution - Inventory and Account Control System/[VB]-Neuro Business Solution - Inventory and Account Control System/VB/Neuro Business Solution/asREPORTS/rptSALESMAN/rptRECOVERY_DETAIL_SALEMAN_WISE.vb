...
Public Class rptRECOVERY_DETAIL_SALEMAN_WISE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRECOVERY_DETAIL_SALEMAN_WISE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRECOVERY_DETAIL_SALEMAN_WISE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRECOVERY_DETAIL_SALEMAN_WISE = New rptRECOVERY_DETAIL_SALEMAN_WISE
        rpt.Site = Me.Site
        Return rpt
    End Function
