...
Public Class rptORDER_FORM_CATEGORY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptORDER_FORM_CATEGORY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptORDER_FORM_CATEGORY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptORDER_FORM_CATEGORY = New rptORDER_FORM_CATEGORY
        rpt.Site = Me.Site
        Return rpt
    End Function
