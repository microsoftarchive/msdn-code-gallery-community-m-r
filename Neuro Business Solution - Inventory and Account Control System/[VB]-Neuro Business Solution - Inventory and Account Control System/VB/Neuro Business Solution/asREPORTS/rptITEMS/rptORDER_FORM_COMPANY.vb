...
Public Class rptORDER_FORM_COMPANY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptORDER_FORM_COMPANY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptORDER_FORM_COMPANY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptORDER_FORM_COMPANY = New rptORDER_FORM_COMPANY
        rpt.Site = Me.Site
        Return rpt
    End Function
