...
Public Class rptBANK_WITHDRAWAL_HISTORY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptBANK_WITHDRAWAL_HISTORY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBANK_WITHDRAWAL_HISTORY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBANK_WITHDRAWAL_HISTORY = New rptBANK_WITHDRAWAL_HISTORY
        rpt.Site = Me.Site
        Return rpt
    End Function
