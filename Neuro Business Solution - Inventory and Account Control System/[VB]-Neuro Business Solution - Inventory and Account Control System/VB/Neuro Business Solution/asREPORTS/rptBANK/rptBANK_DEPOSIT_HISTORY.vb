...
Public Class rptBANK_DEPOSIT_HISTORY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptBANK_DEPOSIT_HISTORY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBANK_DEPOSIT_HISTORY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBANK_DEPOSIT_HISTORY = New rptBANK_DEPOSIT_HISTORY
        rpt.Site = Me.Site
        Return rpt
    End Function
