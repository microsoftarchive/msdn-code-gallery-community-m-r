...
Public Class rptBANK_ADJ_HISTORY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptBANK_ADJ_HISTORY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBANK_ADJ_HISTORY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBANK_ADJ_HISTORY = New rptBANK_ADJ_HISTORY
        rpt.Site = Me.Site
        Return rpt
    End Function
