...
Public Class rptPURCHASE_INVOICE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPURCHASE_INVOICE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPURCHASE_INVOICE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPURCHASE_INVOICE = New rptPURCHASE_INVOICE
        rpt.Site = Me.Site
        Return rpt
    End Function
