...
<System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 System.Xml.Serialization.XmlRootAttribute("dsV_SUPPLIER_PAYMENT"),  _
 System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class dsV_SUPPLIER_PAYMENT
    ...
    Public Overrides Function Clone() As System.Data.DataSet
        Dim cln As dsV_SUPPLIER_PAYMENT = CType(MyBase.Clone,dsV_SUPPLIER_PAYMENT)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsV_SUPPLIER_PAYMENT"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/dsV_SUPPLIER_PAYMENT.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As System.Xml.Schema.XmlSchemaSet) As System.Xml.Schema.XmlSchemaComplexType
        Dim ds As dsV_SUPPLIER_PAYMENT = New dsV_SUPPLIER_PAYMENT
    ...
    Partial Public Class V_SUPPLIER_PAYMENTDataTable
        ...
        Public Overloads Function AddV_SUPPLIER_PAYMENTRow( _
                    ...
                    ByVal USER_NAME As String) As V_SUPPLIER_PAYMENTRow
            Dim rowV_SUPPLIER_PAYMENTRow As V_SUPPLIER_PAYMENTRow = CType(Me.NewRow,V_SUPPLIER_PAYMENTRow)
            rowV_SUPPLIER_PAYMENTRow.ItemArray = New Object() {Nothing, SUPPLIER_ID, SUPPLIER_NAME, PMT_DATE, CASH_AMT, CHQ_NO, CHQ_TYPE, CHQ_DATE, BANK_AMT, BANK_ACC, BANK_NAME, PINV_NO, GROUP_NAME, TOT_PAYMENT, EMP_NAME, DESCRIPTION, USER_NAME}
            Me.Rows.Add(rowV_SUPPLIER_PAYMENTRow)
            Return rowV_SUPPLIER_PAYMENTRow
        End Function
        
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function FindByID(ByVal ID As Decimal) As V_SUPPLIER_PAYMENTRow
            Return CType(Me.Rows.Find(New Object() {ID}),V_SUPPLIER_PAYMENTRow)
        End Function
    ...
    Partial Public Class V_SUPPLIER_PAYMENTRow
        ...
        Public Property PMT_DATE() As Date
            Get
                ...
                Catch e As System.InvalidCastException
                    Throw New System.Data.StrongTypingException("The value for column 'PMT_DATE' in table 'V_SUPPLIER_PAYMENT' is DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Property PINV_NO() As String
            Get
                Try 
                    Return CType(Me(Me.tableV_SUPPLIER_PAYMENT.PINV_NOColumn),String)
                Catch e As System.InvalidCastException
        ...
        Public Function IsPMT_DATENull() As Boolean
            Return Me.IsNull(Me.tableV_SUPPLIER_PAYMENT.PMT_DATEColumn)
        End Function
        
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetPMT_DATENull()
            Me(Me.tableV_SUPPLIER_PAYMENT.PMT_DATEColumn) = System.Convert.DBNull
        End Sub
