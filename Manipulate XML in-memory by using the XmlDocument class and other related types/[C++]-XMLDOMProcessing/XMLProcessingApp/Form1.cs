...
namespace XMLProcessingApp
{
    public partial class Form1 : Form
    {
            ...
            if (_doc != null)
            {
                if (newISBNTextBox.Text != "")
                {
                    ...
                    if (bookElement != null)
                    {
                        ...
                        if (!_xmlHelperMethods.InsertBookElement(bookElement, positionComboBox.Text, selectedBookNode,
                            validateCheckBox.Checked, generateSchemaCheckBox.Checked))
                        {
                            MessageBox.Show("The following critical validation errors occurred: " + _xmlHelperMethods.ValidationError);
                        }
        ...
        private void submitButton_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!_xmlHelperMethods.editBook(editTitleTextBox.Text, editISBNTextBox.Text,
